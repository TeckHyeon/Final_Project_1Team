...
public class WebMvcConfiguration implements WebMvcConfigurer {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		/*
		 * new LoginCheckInterceptor()).addPathPatterns("/**").excludePathPatterns(
		 * "/loginFail")
		 ...
		 * .excludePathPatterns("/css/**", "/js/**", "/image/**", "/audio/**",
		 * "/node_modules/**")
		 * .excludePathPatterns("/detail").excludePathPatterns("upload/**").
		 * excludePathPatterns("/search") .excludePathPatterns("/index");
		 */
	...
	public CommonsMultipartResolver multipartResolver() {
		...
		// apache의 Commons-io 및 Commons-fileupload를 사용하기 때문에 CommonsMultipartResolver를
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		registry.addResourceHandler("/upload/**")
				.addResourceLocations("file:///D:/Java/jsp-study/music_cloud/audio/");
